...
$lang->repo->error->notFound      = "版本庫『%s』路徑 %s 不存在，請確認此版本庫是否已在本地伺服器被刪除";

$lang->repo->syncTips          = '請參照<a target="_blank" href="https://www.zentao.pm/book/zentaopmshelp/207.html">這裡</a>，設置版本庫定時同步。';
