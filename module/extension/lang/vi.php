...
$lang->extension->latest           = '<small>Latest:<strong><a href="%s" target="_blank" class="extension">%s</a></strong>，need zentao <a href="https://api.zentao.pm/goto.php?item=latest" target="_blank"><strong>%s</strong></small>';
...
$lang->extension->errorGetExtensions           = 'Nhận Extensions from www.zentao.pm failed. It could be network error. Vui lòng go to <a href="https://www.zentao.pm/extension/" target="_blank" class="alert-link">www.zentao.pm</a> and download the extension, and then upload it to install.';
