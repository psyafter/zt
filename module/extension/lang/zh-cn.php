...
$lang->extension->latest      = '<small>最新版本<strong><a href="%s" target="_blank" class="extension">%s</a></strong>，兼容禅道<a href="https://api.zentao.pm/goto.php?item=latest" target="_blank" class="alert-link"><strong>%s</strong></a></small>';
...
$lang->extension->errorGetModules              = '从www.zentao.pm获得插件分类失败。可能是因为网络方面的原因，请检查后重新刷新页面。';
$lang->extension->errorGetExtensions           = '从www.zentao.pm获得插件失败。可能是因为网络方面的原因，您可以到 <a href="https://www.zentao.pm/extension/" target="_blank" class="alert-link">www.zentao.pm</a> 手工下载插件，然后上传安装。';
