...
$lang->extension->latest           = '<small>Letzte:<strong><a href="%s" target="_blank" class="extension">%s</a></strong>，benötigt ZenTao <a href="http://api.zentao.pm/goto.php?item=latest" target="_blank"><strong>%s</strong></small>';
...
$lang->extension->errorGetModules              = 'Die Kategorie konnte nicht von www.zentao.pm ermittelt werden. Es könnte eine Netzwerkfehler vorliegen. Bitte prüfen Sie die Verbindung und aktualisieren Sie die Seite.';
$lang->extension->errorGetExtensions           = 'Die Erweiterung konnte nicht von www.zentao.pm geladen werden. Es könnte eine Netzwerkfehler vorliegen. Bitte besuchen Sie <a href="https://www.zentao.pm/extension/" target="_blank" class="alert-link">www.zentao.pm</a> und laden Sie die Erweiterung. Anschließend laden Sie die Erweiterung hoch und installieren sie.';
