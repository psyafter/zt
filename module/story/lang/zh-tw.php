...
$lang->story->batchToTaskTips = "此操作會創建與所選{$lang->storyCommon}同名的任務，並將{$lang->storyCommon}關聯到任務中，已關閉的需求不會轉為任務。";
...
$lang->story->duplicateStory = "重複{$lang->storyCommon}ID";
...
$lang->story->errorNotSubdivide    = "狀態不是激活，或者階段不是未開始的{$lang->storyCommon}，或者是子需求，則不能細分。";
