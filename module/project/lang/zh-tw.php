...
$lang->project->errorSamePlans     = '項目不能關聯多個相同的計劃。';
...
$lang->project->daysGreaterProject = '可用工日不能大於項目的可用工日『%s』';
...
$lang->project->allProjects        = '所有項目';
$lang->project->ignore             = '忽略';

/* Fields. */
$lang->project->common             = '項目';
$lang->project->id                 = '項目ID';
...
$lang->project->closedProject   = '已關閉的項目';
...
$lang->project->productTip             = '點擊新建產品後，項目將不會關聯已選中的產品。';
$lang->project->noDevStage             = '該項目下沒有研發類型的階段，或者您沒有權限訪問，暫時不支持創建版本。';
$lang->project->budgetOverrun          = '項目的預算超出了父項目集的剩餘預算：';
$lang->project->disabledInputTip       = '請先取消%s';
$lang->project->summary                = '本頁共 <strong>%s</strong> 個項目。';
$lang->project->allSummary             = '本頁共 <strong>%s</strong> 個項目，未開始 <strong>%s</strong>，進行中 <strong>%s</strong>，已掛起 <strong>%s</strong>，已關閉 <strong>%s</strong> 。';
$lang->project->checkedSummary         = '選中 <strong>%total%</strong> 個項目。';
$lang->project->checkedAllSummary      = '選中 <strong>%total%</strong> 個項目，未開始 <strong>%wait%</strong>，進行中 <strong>%doing%</strong>，已掛起 <strong>%suspended%</strong>，已關閉 <strong>%closed%</strong> 。';
...
$lang->project->kanbanAclList['private'] = "私有 (只有項目負責人、團隊成員可訪問)";
$lang->project->kanbanAclList['open']    = "公開 (有項目視圖權限即可訪問)";

$lang->project->kanbanSubAclList['private'] = "私有 (只有項目負責人、團隊成員可訪問)";
$lang->project->kanbanSubAclList['open']    = "公開 (有項目視圖權限即可訪問)";
$lang->project->kanbanSubAclList['program'] = '項目集內公開（所有上級項目集負責人和干係人、項目負責人、團隊成員可訪問）';
...
$lang->project->beginLetterParent    = "項目的開始日期小於了父項目集的開始日期：";
$lang->project->endGreaterParent     = "項目的完成日期大於了父項目集的完成日期：";
$lang->project->dateExceedParent     = "項目的起止日期已超出父項目集的起止日期：";
$lang->project->beginGreateChild     = '項目的開始日期應大於等於項目集的最小開始日期：%s';
$lang->project->endLetterChild       = '項目的完成日期應小於等於項目集的最大完成日期：%s';
$lang->project->begigLetterExecution = '項目的開始日期應小於等於執行的最小開始日期：%s';
$lang->project->endGreateExecution   = '項目的完成日期應大於等於執行的最大完成日期：%s';
$lang->project->childLongTime        = "子項目中有長期項目，父項目也應該是長期項目";
