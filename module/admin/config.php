...
$config->admin->plugins[203]->viewLink = 'https://www.zentao.pm/extension-viewExt-203.html';
...
$config->admin->plugins[198]->viewLink = 'https://www.zentao.pm/extension-viewExt-198.html';
...
$config->admin->plugins[27]->viewLink = 'https://www.zentao.pm/extension-viewExt-27.html';
...
$config->admin->plugins[26]->viewLink = 'https://www.zentao.pm/extension-viewExt-26.html';
...
$config->admin->plugins[30]->viewLink = 'https://www.zentao.pm/extension-viewExt-30.html';
...
$config->admin->plugins[194]->viewLink = 'https://www.zentao.pm/extension-viewExt-194.html';

$config->admin->apiRoot        = 'https://www.zentao.pm';
$config->admin->cdnRoot        = 'https://cdn.easycorp.cn/web';
$config->admin->classURL       = 'https://www.zentao.pm/publicclass.html';
$config->admin->dynamicURL     = 'https://www.zentao.pm/download.html';
$config->admin->extensionURL   = 'https://www.zentao.pm/extension-browse.html';
$config->admin->patchURL       = 'https://www.zentao.pm/extension-browse-byModule-1218.html';
$config->admin->apiSite        = 'https://api.zentao.pm/';
...
$config->admin->helpURL['system']    = 'https://www.zentao.pm/book/zentaopms/538.html';
$config->admin->helpURL['company']   = 'https://www.zentao.pm/book/zentaopms/38.html';
$config->admin->helpURL['switch']    = 'https://www.zentao.pm/book/zentaopms/38.html';
$config->admin->helpURL['model']     = 'https://www.zentao.pm/book/zentaopms/533.html';
$config->admin->helpURL['feature']   = 'https://www.zentao.pm/book/zentaopms/38.html';
$config->admin->helpURL['template']  = 'https://www.zentao.pm/book/zentaopms/38.html';
$config->admin->helpURL['message']   = 'https://www.zentao.pm/book/zentaopms/email-notification-541.html';
$config->admin->helpURL['extension'] = 'https://www.zentao.pm/book/zentaopms/536.html';
$config->admin->helpURL['dev']       = 'https://www.zentao.pm/book/zentaopms/537.html';
$config->admin->helpURL['convert']   = 'https://www.zentao.pm/book/zentaopms/656.html';
