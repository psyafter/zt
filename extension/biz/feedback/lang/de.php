...
$lang->feedback->productModule  = 'Product module';
$lang->feedback->syncProduct    = 'Synchronize product modules';
$lang->feedback->syncProductTo  = 'Sync to product';
$lang->feedback->syncConfirm    = 'Whether to merge the existing module with the product module';
$lang->feedback->syncWarning    = 'After the product module is synchronized, it cannot be revoked. Please click Confirm carefully';
...
$lang->feedback->featureBar['admin']['more']['tostory']       = "Have to {$lang->SRCommon}";
$lang->feedback->featureBar['admin']['more']['torequirement'] = "Have to {$lang->URCommon}";
$lang->feedback->featureBar['admin']['more']['totask']        = 'Have to Task';
$lang->feedback->featureBar['admin']['more']['tobug']         = 'Have to Bug';
$lang->feedback->featureBar['admin']['more']['totodo']        = 'Have to Todo';
$lang->feedback->featureBar['admin']['more']['toticket']      = 'Have to Ticket';
