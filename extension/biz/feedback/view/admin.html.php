...
<div id='mainMenu' class="clearfix">
  ...
  <div class='btn-toolbar pull-left'>
    ...
    {
        if($browseType == 'byProduct' or $browseType == 'byModule') $browseType = 'all';
        ...
        if($type == 'more')
        {
            if(isset($lang->feedback->featureBar['admin']['more'][$browseType]))
            {
                $dropdownName = $lang->feedback->featureBar['admin']['more'][$browseType];
            ...
            foreach($label as $moreType => $moreLabel)
            {
