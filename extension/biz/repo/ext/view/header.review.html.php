...
<div class='panel panel-sm hide panel-bug' id='bugPanel'>
  <div class='panel-heading'>
    <div class="bug-title">
      ...
      <a href='javascript:;' class='view-bug  <?php if(!isonlybody()) echo "iframe";?>'>Bug #<span class='bugid'></span></a>
      <?php else:?>
    ...
    <div class='panel-actions pull-right'>
      ...
      <a href='javascript:;' class='edit bugEdit <?php if(!isonlybody()) echo "iframe";?>' data-width="95%"><i class='icon icon-pencil'></i></a>
      <?php endif;?>
