$(function()
{
    var rejectURL = $('.modal-body .page-actions > .btn-group > .loadInModal').attr('href');
    $('.modal-body .page-actions .btn-group > .loadInModal').attr('href', rejectURL + (rejectURL.indexOf('?') > 0 ? '&' : '?') + 'onlybody=yes');
