...
$lang->dataset->objects['productplan'] = '产品计划';
...
$lang->dataset->tables['build']       = array('name' => '版本数据', 'desc' => '包括版本名称、所属产品、所属项目、所属执行、创建人等');
$lang->dataset->tables['product']     = array('name' => '产品数据', 'desc' => '包括产品名称、所属产品线、所属项目集、产品代号、创建人等');
$lang->dataset->tables['productplan'] = array('name' => '产品计划数据', 'desc' => '包括计划名称、所属产品、父计划、开始时间、结束时间等');
$lang->dataset->tables['release']     = array('name' => '产品发布数据', 'desc' => '包括发布名称、所属产品、所属项目、相关版本、创建人等');
$lang->dataset->tables['project']     = array('name' => '项目数据', 'desc' => '包括项目名称、项目代号、项目模型、开始时间、结束时间等');
$lang->dataset->tables['execution']   = array('name' => '执行数据', 'desc' => '包括执行名称、执行代号、所属项目、开始时间、结束时间等');
$lang->dataset->tables['task']        = array('name' => '任务数据', 'desc' => '包括任务名称、优先级、指派人、所属执行、创建人等');
//$lang->dataset->tables['team']        = array('name' => '团队数据', 'desc' => '包括所属项目、所属执行、团队成员等');
$lang->dataset->tables['bug']         = array('name' => 'Bug数据', 'desc' => '包括Bug严重程度、优先级、解决人、所属项目、所属产品等');
$lang->dataset->tables['bugbuild']    = array('name' => '版本Bug数据', 'desc' => '版本的Bug严重程度、优先级、解决人、所属项目、所属产品等');
...
$lang->dataset->typeList['custom']   = '自定义数据';
