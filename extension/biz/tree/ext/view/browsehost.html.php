          ...
          <table class='table table-form table-auto'>
            <tr>
              <td class="text-middle text-right with-padding">
                ...
                {
                    echo '<span>' . html::a($this->createLink('tree', 'browseHost', "moduleID=$parent->id"), $parent->name, '_self', '', false) . ($pkey+1 < count($parents) ? "<i class='icon icon-angle-right muted'></i>" : '') . '</span>';
                }
                ?>
              </td>
              <td id='moduleBox'>
                ...
                <div id="insertItemBox" class="template">
                  <div class="table-row row-module row-module-new">
                    <div class="table-col col-module"><?php echo html::input("modules[]", '', "class='form-control' placeholder='{$lang->tree->groupName}' autocomplete='off'");?></div>
