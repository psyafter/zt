          ...
          <tr>
            ...
            <td>
              <div class='input-group' id='moduleBox'>
                ...
                <?php echo html::select('module', $modules, '', "class='form-control chosen' required");?>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class='input-group'>
                ...
                <?php echo html::select('openedBuild[]', $builds, '', "class='form-control picker-select'");?>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2">
              <div class='input-group' style='display: flex;'>
                ...
                <div class='table-col c-actions w-60px text-right'>
          ...
          <tr>
            ...
            <td colspan='2'>
              <div class='keep-row-height'>
                ...
                <span class="input-group-addon fix-border br-0 priBox"><?php echo $lang->ticket->pri;?></span>
    ...
    <tr id="addItem" class="hidden">
      ...
      <td colspan="2">
        <div class='input-group' style='display: flex;'>
          ...
          <div class='table-col c-actions w-60px text-right' style='flex: 0 0 60px'>
            <a href='javascript:;' onclick='addItem(this)' class='btn btn-link' title='<?php echo $lang->ticket->addSource;?>'><i class='icon-plus'></i></a>
...
<script>
var deallineWidth = $('#deadline').parent().parent().width();
var gap = deallineWidth - 60;
