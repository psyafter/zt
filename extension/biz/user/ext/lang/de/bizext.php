...
$lang->user->noticeFeedbackCreate = "The limited number of feedback users is %maxcount%, and the number of added users is %usercount%, which will exceed the limit. Please clear the redundant users.";
