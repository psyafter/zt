      ...
      <table class="table table-borderless">
        <tbody>
          ...
          <tr>
            ...
            <td class="severity[<?php echo $auditplanID;?>][<?php echo $list->id;?>] hidden"><?php echo html::select("severity[$auditplanID][$list->id]", $lang->nc->severityList, '', "class='form-control chosen'");?></td>
          </tr>
          <?php endforeach;?>
          <?php endforeach;?>
          <tr>
