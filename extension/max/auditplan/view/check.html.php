      ...
      <table class="table table-borderless">
        <tbody>
          <tr>
            ...
            <th class='w-150px text-left severity  hidden'><?php echo $lang->auditplan->severity;?></th>
          </tr>
          ...
          <tr>
            ...
            <td class='severity[<?php echo $list->id;?>] hidden'><?php echo html::select("severity[$list->id]", $lang->nc->severityList, '', "class='form-control chosen'");?></td>
          </tr>
          <?php endforeach;?>
          <tr>
