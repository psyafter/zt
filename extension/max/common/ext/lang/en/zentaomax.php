...
$lang->my->menu->work['subMenu']->audit     = array('link' => 'Aduit|my|work|mode=audit&type=needreview', 'subModule' => 'review');
...
$lang->waterfall->menu->execution['subMenu']->lists = array('link' => 'Stage|project|execution|status=all&projectID=%s','subModule' => 'execution,programplan');
$lang->waterfall->menu->execution['subMenu']->gantt = array('link' => 'Gantt|programplan|browse|projectID=%s&productID=0&type=gantt');
...
$lang->admin->menu->approvalflow = array('link' => 'Approval|approvalflow|browse|', 'subModule' => 'approvalflow', 'subMenu');
$lang->admin->menuOrder[23]  = 'approvalflow';

$lang->admin->menu->allModel['subMenu']->subject      = array('link' => 'Account|subject|browse|');
$lang->admin->menu->allModel['subMenu']->estimate     = array('link' => 'Estimation|custom|estimate');
$lang->admin->menu->allModel['subMenu']->baseline     = array('link' => 'Document Template|baseline|template', 'subModule' => 'baseline');
$lang->admin->menu->allModel['subMenu']->meetingroom  = array('link' => 'Meeting Room|meetingroom|browse', 'alias' => 'create,edit,view,batchcreate,batchedit');
$lang->admin->menu->allModel['subMenu']->measurement  = array('link' => 'Measurement|measurement|settips|', 'subModule' => 'sqlbuilder,measurement,report');
...
$lang->admin->menu->waterfall['subMenu']->design      = array('link' => 'Design|design|settype|', 'subModule' => 'design');
...
$lang->admin->menu->waterfall['subMenu']->process     = array('link' => 'Process|process|browse|browseType=waterfall', 'subModule' => ',activity,zoutput,classify,', 'alias' => 'create,edit,view,batchcreate');
...
$lang->admin->menu->scrum['subMenu']->process = array('link' => 'Process|process|browse|browseType=scrum', 'subModule' => 'process,activity,zoutput,classify,');
...
$lang->searchObjects['opportunity'] = 'Opportunity';
$lang->searchObjects['trainplan']   = 'Train Plan';
