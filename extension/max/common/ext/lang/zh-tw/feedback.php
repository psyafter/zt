...
$lang->feedback->menu->browse   = array('link' => '反饋|feedback|admin|browseType=wait', 'alias' => 'create,edit,view,adminview,batchedit,browse,showimport');
...
{
    $lang->feedback->menu->browse = array('link' => '反饋|feedback|browse|browseType=unclosed', 'alias' => 'create,edit,view,batchedit,browse');
