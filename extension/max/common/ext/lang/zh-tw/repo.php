...
$lang->devops->menu->review = array('link' => '評審|repo|review|repoID=%s', 'subModule' => 'bug', 'alias' => 'diff');
...
$lang->devops->menu->review['subMenu']->diff   = array('link' => "對比|repo|diff|repoID=%s");
