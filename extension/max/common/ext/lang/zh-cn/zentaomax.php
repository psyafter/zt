...
$lang->my->menu->work['subMenu']->audit     = array('link' => '评审|my|work|mode=audit&type=needreview', 'subModule' => 'review');
...
$lang->waterfall->menu->execution['subMenu']->gantt = array('link' => '甘特图|programplan|browse|projectID=%s&productID=0&type=gantt');
$lang->waterfall->menu->execution['subMenu']->lists = array('link' => '阶段列表|project|execution|status=all&projectID=%s','subModule' => 'execution,programplan,task');
...
$lang->admin->menu->approvalflow = array('link' => '审批|approvalflow|browse|', 'subModule' => 'approvalflow', 'subMenu');
...
$lang->admin->menu->allModel['subMenu']->baseline     = array('link' => '文档模板|baseline|template', 'subModule' => 'baseline');
$lang->admin->menu->allModel['subMenu']->meetingroom  = array('link' => '会议室|meetingroom|browse', 'alias' => 'create,edit,view,batchcreate,batchedit');
...
$lang->admin->menu->waterfall['subMenu']->design      = array('link' => '设计|design|settype|', 'subModule' => 'design');
...
$lang->admin->menu->waterfall['subMenu']->process     = array('link' => '过程|process|browse|browseType=waterfall', 'subModule' => ',activity,zoutput,classify,', 'alias' => 'create,edit,view,batchcreate');
...
$lang->admin->menu->scrum['subMenu']->process = array('link' => '过程|process|scrumbrowse|browseType=scrum', 'subModule' => 'process,activity,zoutput,classify,');
...
$lang->searchObjects['opportunity'] = '机会';
$lang->searchObjects['trainplan']   = '培训计划';
