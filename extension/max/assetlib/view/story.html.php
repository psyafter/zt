    ...
    <table class="table has-sort-head" id='storyList'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class='text-center' id='pri'><?php echo "<span class='label-pri label-pri-" . $story->pri . "'" . "' title='" . zget($this->lang->story->priList, $story->pri, $story->pri) . "'>" . zget($lang->story->priList, $story->pri) . "</span>";?></td>
          ...
          <?php if($browseType == 'all' or $browseType == 'bysearch'):?>
          <td><?php echo $story->status == 'active' ? zget($approvers, $story->assignedTo) : '';?></td>
