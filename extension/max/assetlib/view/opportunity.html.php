    ...
    <table class="table has-sort-head" id='opportunityList'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class='text-center' id='pri'><?php echo "<span class='pri-{$opportunity->pri}'>" . zget($lang->opportunity->priList, $opportunity->pri) . "</span>";?></td>
          ...
          <?php endif;?>
          <td title="<?php echo zget($users, $opportunity->createdBy);?>"><?php echo zget($users, $opportunity->createdBy);?></td>
          <td><?php echo helper::isZeroDate($opportunity->createdDate) ? '' : substr($opportunity->createdDate, 0, 11);?></td>
          <?php if($browseType == 'all' or $browseType == 'bysearch'):?>
          <td><?php echo $opportunity->status == 'active' ? zget($approvers, $opportunity->assignedTo) : '';?></td>
