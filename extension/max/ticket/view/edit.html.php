    ...
    <div class='main-row'>
      <div class='main-col col-8'>
        <div class='cell'>
          ...
          <?php if(!empty(trim($ticket->resolution))):?>
            ...
            <table class='table table-form'>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class='input-group'>
                    <?php echo html::select('openedBuild[]', $builds, $ticket->openedBuild, " class='form-control picker-select' multiple"); ?>
                    </div>
                  </td>
                </tr>
                <tr>
          ...
          <div class='detail'>
            ...
            <table class='table table-form'>
              <tbody>
                ...
                <tr>
                  <th class='w-80px'><?php echo $lang->ticket->finishedBy;?></th>
                  <td>
                    <div class='input-group'>
                      <?php echo html::select('resolvedBy', $users, $ticket->finishedBy, " class='form-control chosen' $disableResolvedBy");?>
                    </div>
                  </td>
                </tr>
                <tr>
                  <th class='w-80px'><?php echo $lang->ticket->finishedDate;?></th>
                  <td>
                    <div class='input-group'>
