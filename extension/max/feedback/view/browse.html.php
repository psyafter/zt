...
<div id='mainMenu' class='clearfix'>
  ...
  <?php if(common::hasPriv('feedback', 'create')) echo html::a(inlink('create', "extras=moduleID=$moduleID"), "<i class='icon-plus'></i>" . $lang->feedback->create, '', "class='btn btn-primary'")?>
  </div>
</div>
