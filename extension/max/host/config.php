...
$config->host->create->requiredFields = 'name,agentPort,instanceNum,pri,tags,provider,bridgeID,privateIP,publicIP';
$config->host->edit->requiredFields   = 'name,agentPort,instanceNum,pri,tags,provider,bridgeID,privateIP,publicIP';
$config->host->create->intFields      = 'cpuNumber,cpuCores,agentPort,instanceNum,pri';
$config->host->create->ipFields       = 'privateIP,publicIP';
