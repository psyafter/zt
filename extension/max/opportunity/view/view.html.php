  ...
  <div class="main-col col-8">
    ...
    <div class='main-actions'>
      <div class="btn-toolbar">
        ...
        if(common::hasPriv('opportunity', 'importToLib')) echo html::a('#importToLib', "<i class='icon icon-assets'></i> " . $this->lang->opportunity->importToLib, '', 'class="btn" data-toggle="modal"');
            ...
            <table class="table table-data">
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if($opportunity->execution) common::printLink('execution', 'view', "executionID=$opportunity->execution", zget($executions, $opportunity->execution), '', 'data-app="execution"');?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <?php $pri = $opportunity->pri == 'low' ? '3' : ($opportunity->pri == 'middle' ? '2' : '1');?>
                  <td><span class='label-pri <?php echo 'label-pri-' . $pri;?>' title='<?php echo zget($lang->opportunity->priList, $opportunity->pri)?>'><?php echo zget($lang->opportunity->priList, $opportunity->pri)?></span></td>
                </tr>
                <tr>
