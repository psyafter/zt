    ...
    <div class='main-actions'>
      <div class="btn-toolbar">
        ...
        <?php
          ...
          if(common::hasPriv('issue', 'importToLib')) echo html::a('#importToLib', "<i class='icon icon-assets'></i> " . $this->lang->issue->importToLib, '', 'class="btn" data-toggle="modal"');
            ...
            <table class="table table-data">
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $this->issue->printAssignedHtml($issue, $users);?></td>
                </tr>
                <tr>
