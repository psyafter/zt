...
$lang->action->objectTypes['auditcl']        = '审核项';
...
$lang->action->label->auditcl             = '审核项|auditcl|view|auditclID=%s';
$lang->action->label->review              = '评审|review|view|reviewID=%s';
$lang->action->label->reviewissue         = '评审问题|reviewissue|issue|reviewissueID=%s';
