...
$lang->action->objectTypes['auditcl']        = '審核項';
...
$lang->action->label->auditcl             = '審核項|auditcl|view|auditclID=%s';
$lang->action->label->review              = '評審|review|view|reviewID=%s';
$lang->action->label->reviewissue         = '評審問題|reviewissue|issue|reviewissueID=%s';
