...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    ...
    echo html::a(inlink($app->rawMethod, "mode=$mode&type=futureMeeting"), "<span class='text'>{$lang->meeting->featureBar['browse']['participate']}</span>"   . ($browseType == 'futureMeeting' ? $recTotalLabel : ''),   '', "class='btn btn-link" . ($browseType == 'futureMeeting' ? ' btn-active-text' : '') . "'");
    ?>
